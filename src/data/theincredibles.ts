...
export const TheIncredibles: H.Record =
{
    ...
    [{
        ...
        notes: {
            ...
            missing_br: [H.transcription(`Desaparecido`), H.literally(`"Missing"`)],
            missing_fr: [H.transcription(`Disparu`), H.literally(`"Missing"`)],
            missing_ja: [H.transcription(`行方不明`, `yukue fumei`), H.literally(`"Whereabouts unknown"`)],
